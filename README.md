[![Run App Janice Shu Lin Chng](https://github.com/janice616/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/janice616/GithubActions/actions/workflows/run-app.yaml)
